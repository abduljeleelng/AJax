...
<script src="../../Jquery/library/jquery-1.11.1.min.js"></script>
<script>
    $(document).ready(function(){
        ...
        $('#postJson').click(function(){
             ...
             */
            $.post('../../API/product/create.php', { name: "Yusuff", price: "6000", description: "noblesoft/",category_id:"3" }, function(data){
